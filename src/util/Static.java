...
public class Static {
    ...
    public static String[] getProvCity(int provIndex, int cityIndex) {
        String[] provinceArr = new String[35];
        provinceArr[0] = "北京市";
        provinceArr[1] = "天津市";
        provinceArr[2] = "上海市";
        provinceArr[3] = "重庆市";
...
//市县,每个数组第一个元素为省份,其他的为这个省份下的市县
        ...
        String[] strings = cityArr[provIndex].split(",");
        return new String[]{provinceArr[provIndex], strings[cityIndex].replaceAll(" ", "")};
    }
}
