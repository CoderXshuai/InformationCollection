...
- [InformationCollectionSystem](#informationcollectionsystem)
  ...
  - [4.项目进度](#4项目进度)
## 1.项目描述
一个能实现提交收集信息的web系统,完成了登录注册,个人信息管理,对收件夹的增删改查以及对
已收集文件的上传和下载.
项目架构为:SSH框架+MySQL数据库+layUI前端模板,以action,service,dao层为后台项目主要结构
...
上传的图片资源,包括头像和logo
##### 3.4.4.2 inbox
收件夹的收集的文件,因为全是json格式,所以放在json文件夹中
#### 3.4.5 layui
laiUI的包
#### 3.4.6 WEB-INF
web.xml的配置文件
