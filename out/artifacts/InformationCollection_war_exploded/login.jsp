...
<form id="loginForm" class="form-horizontal" style="width: 400px;text-align: center;">
    ...
    <div class="form-group" style="margin-top: 20px;">
        <div class="col-sm-10 col-sm-offset-1">
            <input type="password" style="height: 40px;" name="password" class="form-control" placeholder="输入密码"
                   required="required" autocomplete="off">
        </div>
    </div>
    <div class="form-group" style="margin-top: 20px;">
        <div class="col-sm-10 col-sm-offset-1">
            <input type="submit" style="height: 40px;" class="btn btn-primary form-control" value="登录"
                   required="required">
        </div>
    </div>
    <div class="form-group" style="margin-top: 20px;">
        <div class="col-sm-10 col-sm-offset-1">
            <p>还没有账号？<a href="javascript:showRegister()">立即注册</a></p>
        </div>
    </div>
</form>
<script>
